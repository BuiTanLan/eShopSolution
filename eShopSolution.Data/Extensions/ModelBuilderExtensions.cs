    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig { Key="HomeTitle",Value="This is the home page of eShopSoluton"},
                new AppConfig { Key = "HomeKyeword", Value = "This is the home page of eShopSoluton" },
                new AppConfig { Key = "HomeDescription", Value = "This is the home page of eShopSoluton" }
            );
           ...
           new Product()
           {
            ...
            var roleId = new Guid("B4748151-ACD7-440D-A489-34434EFFECD9");
            var adminId = new Guid("E49BF92D-FECA-44FA-B121-0E1495A84AD8");
            modelBuilder.Entity<AppRole>().HasData(new AppRole
            {
                Id = roleId,
                Name = "admin",
                NormalizedName = "admin",
                Description = "Asministrator role"
            });
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                NormalizedEmail = "tanlanhcmus@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "Asusxiaomi12"),
                SecurityStamp = string.Empty,
                FirstName = "Lan",
                LastName = "Bui Tan",
                Dob = new DateTime(2020,4,9)
            });
